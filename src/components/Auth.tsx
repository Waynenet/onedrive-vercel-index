  ...
  return (
    <div className="mx-auto flex max-w-sm flex-col space-y-4 md:my-10">
      ...
      <div className="flex items-center space-x-2">
        <input
          className="flex-1 rounded-sm border border-gray-600/10 p-2 font-mono focus:ring focus:ring-blue-300 focus:outline-none dark:bg-gray-600 dark:text-white dark:focus:ring-blue-700"
          autoFocus
          type="password"
          placeholder="************"
          value={token}
        ...
        />
        <button
          className="rounded-sm bg-blue-600 px-4 py-2 text-white hover:bg-blue-500 focus:ring focus:ring-blue-400 focus:outline-none"
          onClick={() => {
            setPersistedToken(token)
            router.reload()
          }}
