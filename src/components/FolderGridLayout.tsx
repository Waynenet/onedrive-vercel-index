    ...
    <div className="rounded-sm bg-white shadow-xs dark:bg-gray-900 dark:text-gray-100">
      ...
      <div className="grid grid-cols-2 gap-3 p-3 md:grid-cols-4">
        {folderChildren.map((c: OdFolderChildren) => (
          <div
            key={c.id}
            className="group dark:hover:bg-gray-850 relative overflow-hidden rounded-sm transition-all duration-100 hover:bg-gray-100"
          >
            ...
            <div
              ...
              } absolute top-0 left-0 z-10 m-1 rounded-sm bg-white/50 py-0.5 group-hover:opacity-100 dark:bg-gray-900/50`}
            >
