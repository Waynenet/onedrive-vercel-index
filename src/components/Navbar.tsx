            ...
            >
              <div className="my-8 inline-block w-full max-w-md transform overflow-hidden rounded-lg bg-white p-6 text-left align-middle transition-all dark:bg-gray-900">
                ...
                <div className="mt-8 flex items-center justify-end">
                  <button
                    className="mr-3 inline-flex items-center justify-center space-x-2 rounded-sm bg-blue-500 px-4 py-2 text-white hover:bg-blue-400 focus:ring focus:ring-blue-300 focus:outline-none"
                    onClick={() => setIsOpen(false)}
                  >
                    {t('Cancel')}
                  </button>
                  <button
                    className="inline-flex items-center justify-center space-x-2 rounded-sm bg-red-500 px-4 py-2 text-white hover:bg-red-400 focus:ring focus:ring-red-300 focus:outline-none"
                    onClick={() => clearTokens()}
                  >
